...
from misc.diffusion_utils import extract_tensor_from_value, gaussian_kl, mean_flat, discretized_gaussian_log_likelihood
...
class DDPMGaussianDiffusion:
    ...
    def q_mean_variance(self, x, t):
        ...
        variance = extract_tensor_from_value(self.schedular.sqrt_one_minus_alphas_cumprod, t, x.shape)
        log_variance = extract_tensor_from_value(self.schedular.log_one_minus_alphas_cumprod, t, x.shape)
